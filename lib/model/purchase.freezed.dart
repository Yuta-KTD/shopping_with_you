...
class _$_Purchase implements _Purchase {
  ...
  @override
  String toString() {
    return 'Purchase(userId: $userId, groupId: $groupId, date: $date, name: $name, amount: $amount, category: $category)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, groupId, date, name, amount, category);
...
abstract class _Purchase implements Purchase {
  const factory _Purchase(
      ...
      required final String category}) = _$_Purchase;
